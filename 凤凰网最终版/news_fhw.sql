...
-- ----------------------------
-- Table structure for news_fhw
-- ----------------------------
DROP TABLE IF EXISTS `news_fhw`;
CREATE TABLE `news_fhw`  (
  ...
  `CJSJ` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '采集时间',
  `RKSJ` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '入库时间',
